...
const ProfilePage = ({ User }) => {
    ...
    const EditUserDataDialog_IsOpenHandler = () => editUserDataDialog_SetIsOpen(!editUserDataDialog_IsOpen);
    ...
    const visitsLogRows = [
        { id: 1, arrivalDate: "23/01/2019, 17:23:42", place: "Snow", currentPeople: 23},
        { id: 2, arrivalDate: "21/01/2019, 17:23:42", place: "Alpha", currentPeople: 23},
    ];
        ...
        <div className={classes.profilePageContainer}>
           <div className={classes.profileDataContainer}>
                <div className={classes.editButton}>
                    <VectorButton OnClick={EditUserData}
                                  BorderRadius={"4px"}
                                  BackColor={Constants.Gray} 
                                  Color={Constants.White} 
                                  VectorSource={Constants.Edit}/>
                </div>
                <img className={classes.profileImgContainer} src={"/icons/ninja.png"} alt="user"/>
            ...
            <EditUserDataDialog IsOpen={editUserDataDialog_IsOpen}
